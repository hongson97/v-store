...
public class Product {
    ...
    @GetMapping("/findUnsafe")
    public String findProductsUnsafe(ModelMap mode, @RequestParam(value = "name") String productName) {
        ...
        mode.addAttribute("listProducts", productsList);
        return "list_products";
    ...
    @PostMapping(value = "/showBillVuln")
